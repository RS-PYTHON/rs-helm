...
| app.station.s1a.endpoint.url | string | `"http://mockup-station-prip-s1a.processing.svc.cluster.local:8080/Products"` | PRIP station URL |
| app.station.s2b.endpoint.url | string | `"http://mockup-station-prip-s2b.processing.svc.cluster.local:8080/Products"` | PRIP station URL |
