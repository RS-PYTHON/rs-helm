...
| app.station.prips1a.endpoint.url | string | `"http://mockup-station-prip-s1a.processing.svc.cluster.local:8080/Products"` | PRIP station URL |
| app.station.prips2b.endpoint.url | string | `"http://mockup-station-prip-s2b.processing.svc.cluster.local:8080/Products"` | PRIP station URL |
...
| image.version | string | `"1.0a1"` | Image version, can be a tag or a digest |
