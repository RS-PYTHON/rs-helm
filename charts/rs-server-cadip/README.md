...
| app.station.cadip | object | `{"configFile":"cadip_service_config.yaml","endpoint":"http://mockup-station-cadip-cadip.processing.svc.cluster.local:8080"}` | CADIP station name |
| app.station.cadip.configFile | string | `"cadip_service_config.yaml"` | CADIP config file name |
| app.station.cadip.endpoint | string | `"http://mockup-station-cadip-cadip.processing.svc.cluster.local:8080"` | CADIP station URL |
