...
| app.station.bedc.domain | string | `"mockup-station-edrs.processing.svc.cluster.local"` | EDRS BEDC domain |
...
| app.station.bedc.service.url | string | `"mockup-station-edrs.processing.svc.cluster.local"` | EDRS BEDC station URL |
...
| app.station.pedc.domain | string | `"mockup-station-edrs.processing.svc.cluster.local"` | EDRS PEDC domain |
...
| app.station.pedc.service.url | string | `"mockup-station-edrs.processing.svc.cluster.local"` | EDRS PEDC station URL |
