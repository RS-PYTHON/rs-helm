...
| app.dataLifecyclePeriod | int | `86400` | Period in seconds between the end of a data lifecycle cleaning task and the start of a new one.  If <0, the task is deactivated. |
...
| image.version | string | `"0.2a13.post5.dev0"` | Image version, can be a tag or a digest |
