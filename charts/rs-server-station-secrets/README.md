...
| app.stations.s2a.authentication.token_url | string | `"http://mockup-prip-s2a.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.s2a.authentication.username | string | `"test"` |  |
| app.stations.s2a.domain | string | `"mockup-prip-s2a.processing.svc.cluster.local"` |  |
| app.stations.s2a.service.name | string | `"prip"` |  |
| app.stations.s2a.service.url | string | `"http://mockup-prip-s2a.processing.svc.cluster.local:8080"` |  |
