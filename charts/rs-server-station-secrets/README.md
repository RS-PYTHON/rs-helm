...
| app.stations.adgs2.authentication.token_url | string | `"http://mockup-station-adgs2-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.adgs2.authentication.username | string | `"test"` |  |
| app.stations.adgs2.domain | string | `"mockup-station-adgs2-svc.processing.svc.cluster.local"` |  |
| app.stations.adgs2.service.name | string | `"auxip"` |  |
| app.stations.adgs2.service.url | string | `"http://mockup-station-adgs2-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.cadip_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.cadip_session.authentication.authorization | string | `nil` |  |
| app.stations.cadip_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.cadip_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.cadip_session.authentication.grant_type | string | `"password"` |  |
| app.stations.cadip_session.authentication.password | string | `"test"` |  |
| app.stations.cadip_session.authentication.scope | string | `"sss"` |  |
| app.stations.cadip_session.authentication.token_url | string | `"http://mockup-station-cadip-cadip_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.cadip_session.authentication.username | string | `"test"` |  |
| app.stations.cadip_session.domain | string | `"mockup-station-cadip-ins-svc.processing.svc.cluster.local"` |  |
| app.stations.cadip_session.service.name | string | `"cadip"` |  |
| app.stations.cadip_session.service.url | string | `"http://mockup-station-cadip-cadip_session-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.ins_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.ins_session.authentication.authorization | string | `nil` |  |
| app.stations.ins_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.ins_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.ins_session.authentication.grant_type | string | `"password"` |  |
| app.stations.ins_session.authentication.password | string | `"test"` |  |
| app.stations.ins_session.authentication.scope | string | `"sss"` |  |
| app.stations.ins_session.authentication.token_url | string | `"http://mockup-station-cadip-ins_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.ins_session.authentication.username | string | `"test"` |  |
| app.stations.ins_session.domain | string | `"mockup-station-cadip-ins-svc.processing.svc.cluster.local"` |  |
| app.stations.ins_session.service.name | string | `"cadip"` |  |
| app.stations.ins_session.service.url | string | `"http://mockup-station-cadip-ins_session-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.mps_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.mps_session.authentication.authorization | string | `"Basic test"` |  |
| app.stations.mps_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.mps_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.mps_session.authentication.grant_type | string | `"password"` |  |
| app.stations.mps_session.authentication.password | string | `"test"` |  |
| app.stations.mps_session.authentication.scope | string | `nil` |  |
| app.stations.mps_session.authentication.token_url | string | `"http://mockup-station-cadip-mps_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.mps_session.authentication.username | string | `"test"` |  |
| app.stations.mps_session.domain | string | `"mockup-station-cadip-mps-svc.processing.svc.cluster.local"` |  |
| app.stations.mps_session.service.name | string | `"cadip"` |  |
| app.stations.mps_session.service.url | string | `"http://mockup-station-cadip-mps_session-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.mti_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.mti_session.authentication.authorization | string | `nil` |  |
| app.stations.mti_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.mti_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.mti_session.authentication.grant_type | string | `"password"` |  |
| app.stations.mti_session.authentication.password | string | `"test"` |  |
| app.stations.mti_session.authentication.scope | string | `"openid"` |  |
| app.stations.mti_session.authentication.token_url | string | `"http://mockup-station-cadip-mti_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.mti_session.authentication.username | string | `"test"` |  |
| app.stations.mti_session.domain | string | `"mockup-station-cadip-mti-svc.processing.svc.cluster.local"` |  |
| app.stations.mti_session.service.name | string | `"cadip"` |  |
| app.stations.mti_session.service.url | string | `"http://mockup-station-cadip-mti_session-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.nsg_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.nsg_session.authentication.authorization | string | `nil` |  |
| app.stations.nsg_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.nsg_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.nsg_session.authentication.grant_type | string | `"password"` |  |
| app.stations.nsg_session.authentication.password | string | `"test"` |  |
| app.stations.nsg_session.authentication.scope | string | `nil` |  |
| app.stations.nsg_session.authentication.token_url | string | `"http://mockup-station-cadip-nsg_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.nsg_session.authentication.username | string | `"test"` |  |
| app.stations.nsg_session.domain | string | `"mockup-station-cadip-nsg-svc.processing.svc.cluster.local"` |  |
| app.stations.nsg_session.service.name | string | `"cadip"` |  |
| app.stations.nsg_session.service.url | string | `"http://mockup-station-cadip-nsg_session-svc.processing.svc.cluster.local:8080"` |  |
...
| app.stations.sgs_session.authentication.auth_type | string | `"oauth2"` |  |
| app.stations.sgs_session.authentication.authorization | string | `nil` |  |
| app.stations.sgs_session.authentication.client_id | string | `"client_id"` |  |
| app.stations.sgs_session.authentication.client_secret | string | `"client_secret"` |  |
| app.stations.sgs_session.authentication.grant_type | string | `"password"` |  |
| app.stations.sgs_session.authentication.password | string | `"test"` |  |
| app.stations.sgs_session.authentication.scope | string | `nil` |  |
| app.stations.sgs_session.authentication.token_url | string | `"http://mockup-station-cadip-sgs_session-svc.processing.svc.cluster.local:8080/oauth2/token"` |  |
| app.stations.sgs_session.authentication.username | string | `"test"` |  |
| app.stations.sgs_session.domain | string | `"mockup-station-cadip-sgs-svc.processing.svc.cluster.local"` |  |
| app.stations.sgs_session.service.name | string | `"cadip"` |  |
| app.stations.sgs_session.service.url | string | `"http://mockup-station-cadip-sgs_session-svc.processing.svc.cluster.local:8080"` |  |
